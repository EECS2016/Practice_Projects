...
//
public class Servlet_BE_IntoMain extends HttpServlet{
	//
 ...
 @Override
	public void destroy() {
		System.out.println("ServletÏú»Ù£ºServlet_BE_IntoMain");
	}
 
 public void doFindNews(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException{

  request.getRequestDispatcher("/WEB-INF/EB_View/V_BackEnd/BackEnd_Entity/BE_IntoMain.jsp").forward(request, response);
 }
}